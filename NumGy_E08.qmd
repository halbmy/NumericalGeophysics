---
title: "Numerical Simulation Methods in Geophysics, Exercise 8:<br> 1D/2D EM"
...
* have some drinks and sweets
* finish 2D Poisson problem with singular source
$$ -\div \sigma \grad u = I \delta(\vb r - \vb r_s) $$

Analytical solution: $u=-\frac{I}{2\pi\sigma}\ln r$

* 1D EM problem $\Rightarrow$ 2D EM problem
...
D = np.vstack([np.hstack([A, -M*w]), np.hstack([M*w, A])])
plt.imshow(D)
d = np.hstack([b, b*0])
